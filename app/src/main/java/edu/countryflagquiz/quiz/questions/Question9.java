...
public class Question9 extends AppCompatActivity {
    ...
    public void answer(View view){
        ...
        if (correctAnswer.isChecked()) {
            ...
            currentPointsList.add("9. correct");//adiciona dizendo que a a primeira pergunta foi correta...
            ...
            //MUDANDO DE TELA
            Intent i = new Intent(getApplicationContext(), Question10.class);
            ...
            currentPointsList.add("9. wrong");//adiciona dizendo que a a primeira pergunta foi correta...
