...
public class Question4 extends AppCompatActivity {
    ...
    public void answer(View view){
        ...
        if (correctAnswer.isChecked()) {
            ...
            currentPointsList.add("4. correct");//adiciona dizendo que a a primeira pergunta foi correta...
            ...
            //MUDANDO DE TELA
            Intent i = new Intent(getApplicationContext(), Question5.class);
            ...
            currentPointsList.add("4. wrong");//adiciona dizendo que a a primeira pergunta foi correta...
