...
public class Question8 extends AppCompatActivity {
    ...
    public void answer(View view){
        ...
        if (correctAnswer.isChecked()) {
            ...
            currentPointsList.add("8. correct");//adiciona dizendo que a a primeira pergunta foi correta...
            ...
            //MUDANDO DE TELA
            Intent i = new Intent(getApplicationContext(), Question9.class);
            ...
            currentPointsList.add("8. wrong");//adiciona dizendo que a a primeira pergunta foi correta...
