...
public class Question6 extends AppCompatActivity {
    ...
    public void answer(View view){
        ...
        if (correctAnswer.isChecked()) {
            ...
            currentPointsList.add("6. correct");//adiciona dizendo que a a primeira pergunta foi correta...
            ...
            //MUDANDO DE TELA
            Intent i = new Intent(getApplicationContext(), Question7.class);
            ...
            currentPointsList.add("6. wrong");//adiciona dizendo que a a primeira pergunta foi correta...
