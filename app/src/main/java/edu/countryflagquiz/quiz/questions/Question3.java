...
public class Question3 extends AppCompatActivity {
    ...
    public void answer(View view){
        ...
        if (correctAnswer.isChecked()) {
            ...
            currentPointsList.add("3. correct");//adiciona dizendo que a a primeira pergunta foi correta...
            ...
            //MUDANDO DE TELA
            Intent i = new Intent(getApplicationContext(), Question4.class);
            ...
            currentPointsList.add("3. wrong");//adiciona dizendo que a a primeira pergunta foi correta...
